        ...
        <div className="sign-in31-form-root">
          <div className="sign-in31-form">
            <h2>
              {props.heading1 ?? (
                <Fragment>
                  <h2 className="sign-in31-text10 thq-heading-2">
              ...
              {props.content1 ?? (
                <Fragment>
                  <p className="sign-in31-text07 thq-body-large">
                    Sign in to access state-of-the-art market reports with our
                    secure and easy-to-use AI report generator.
                  </p>
                </Fragment>
              )}
            </p>
...
SignIn31.defaultProps = {
  image1Src:
    'https://images.unsplash.com/photo-1536318916289-2f5c1ab907f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMzIyMDIxN3w&ixlib=rb-4.0.3&q=80&w=1080',
  image1Alt: 'AI report generator for market reports',
  content1: undefined,
  action2: undefined,
  action1: undefined,
  heading1: undefined,
